...
function AdminPanelView.build(context)
	...
	local subtitleLabel = create("TextLabel", {
		...
		Text = "Get tools from ReplicatedStorage.Assets.Items by category.",
	...
	local itemStatusLabel = create("TextLabel", {
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Open with M to load categories.",
	...
	local emptyStateLabel = create("TextLabel", {
		...
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Choose a category in the left column.",
	...
	local rouletteStatusLabel = create("TextLabel", {
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Load this tab to prepare the roulette.",
	...
	local rouletteRuleLabel = create("TextLabel", {
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Admins with 0 Horseshoes roll for free. Normal cost: 500.",
	...
	create("TextLabel", {
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Restores Hunger, Thirst, Cleanliness, Health, and Happiness to 100%.",
	...
	local careStatusLabel = create("TextLabel", {
		BackgroundTransparency = 1,
		Font = Enum.Font.Gotham,
		Text = "Ready to restore the equipped horse.",
		TextColor3 = Color3.fromRGB(175, 228, 187),
		TextSize = 14,
		TextXAlignment = Enum.TextXAlignment.Center,
