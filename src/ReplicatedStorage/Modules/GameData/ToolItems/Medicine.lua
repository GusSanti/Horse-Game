...
return {
	...
	Shared.CreateMedicine({
		...
		IconImage = "rbxassetid://140540020646394",
	...
	Shared.CreateMedicine({
		ShopId = "Doctor",
		ItemId = "injectable_supplement",
		DisplayName = "Injectable Supplement",
		IconImage = "rbxassetid://104089490881314",
		Description = "Injectable supplement to strengthen your horse",
		Price = 6,
		PriceLabel = "6 coin",
		SortOrder = 40,
		Effects = {
	...
	Shared.CreateMedicine({
		...
		IconImage = "rbxassetid://104408256802431",
