...
local HorseSaddleAssetService = require(HorseModules:WaitForChild("HorseSaddleAssetService"))
...
local StableCleaningService = require(HorseModules:WaitForChild("StableCleaningService"))
...
QuestService.Init()
RaceService.Init()
HorseRoamingService.Init()
HorseMountService.Init()
HayBaleService.Init()
WaterTankService.Init()
StableCleaningService.Init()
